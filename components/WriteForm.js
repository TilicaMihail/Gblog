    ...
    return (
        <div className = 'flex justify-center'>
            <form className = 'max-w-[1200px] grow sm:ml-10 sm:mr-10 p-4' onSubmit = {handlePublish} >
                ...
                <input required type="text" value = {description} onChange = {e => setDescription(e.target.value)} className = 'w-full p-2 font-bold text-xl rounded-xl mt-2 mb-2 outline-none border shadow ' placeholder = 'Enter a description' />
